  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="mt-4 text-lg text-muted-foreground">
                  Chez Relax Voyages, nous vous offrons une sélection exceptionnelle de véhicules à la location et à la vente. Que ce soit pour un voyage d'affaires, des vacances en famille ou l'acquisition d'un véhicule importé de l'étranger, nous avons la solution.
                </p>
        ...
        {activeSection === 'sale' && (
            <section className="py-16 sm:py-24 bg-background">
              <div className="container mx-auto max-w-7xl px-4">
                <h2 className="text-3xl md:text-4xl font-bold text-primary text-center mb-6">Acheter Votre Véhicule avec Relax Voyages</h2>
