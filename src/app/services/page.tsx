                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="mt-4 text-lg text-muted-foreground">
                            Chez Relax Voyages, notre mission est de rendre votre expérience de voyage aussi simple et agréable que possible. Nous comprenons que chaque voyageur est unique, c'est pourquoi nous offrons une gamme de services entièrement personnalisables pour répondre à vos moindres désirs.
                        </p>
